...
urlpatterns = [
    ...
    path('payment/<str:order_id>/', views.razorpay_payment_view, name='razorpay_payment'),
    
    path('payment-failed/<str:order_id>/', views.payment_failed_view, name='payment_failed'),
]